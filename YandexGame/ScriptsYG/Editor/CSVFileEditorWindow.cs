                ...
                if (GUILayout.Button("Export", GUILayout.Height(30)))
                {
                    ...
                    for (int i = 0; i < objectsTranlate.Count; i++)
                    {
                        ...
                        if (scr.componentTextField)
                        {
                            ...
                            {
                                textScr = scr.textUIComponent.text;
                                scr.text = textScr;
                            }
                            else if (scr.textMeshComponent)
                            {
                                textScr = scr.textMeshComponent.text;
                                scr.text = textScr;
                            }
                    ...
                    if (langObj.Count > 0)
                    {
                        ...
                        string[,] keys = new string[langObj.Count, infoYG.LangArr().Length + 1];

                        for (int i = 0; i < langObj.Count; i++)
                        {
                            for (int i2 = 0; i2 < infoYG.LangArr().Length + 1; i2++)
                            {
                                if (i2 == 0)
                                    keys[i, 0] = idArr[i];
